...
import ReportPost from './components/Dashboard/ReportPost';
import ReportProcessingPost from './components/Dashboard/ReportProcessingPost';
...
const Markup = () => {
  ...
  const routes = [
    ...
    { url: "news/:newId", component: News },
    { url: "news", component: News },
    { url: "update-info/:userId", component: UpdateInfo },
    { url: "update-info", component: UpdateInfo },
    { url: "create-user", component: CreateUser },
    { url: "report-post", component: ReportPost },
    { url: "processing-report", component: ReportProcessingPost },
    ...
    { url: 'ecom-product-detail/:postId', component: ProductDetail },
    ...
    /// pages
    { url: 'forgot-password', component: Registration },
