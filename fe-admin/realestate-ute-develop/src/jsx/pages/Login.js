...
function Login(props) {
	...
	function onLogin(e) {
		...
		if (password === '') {
			errorObj.password = 'Mật khẩu là bắt buộc';
			error = true;
		}
		setErrors(errorObj);
		if (error) {
							...
							<div className="col-xl-12 tab-content">
								<div id="sign-in" className="auth-form   form-validation">
									...
									<form onSubmit={onLogin} className="form-validate">
										...
										<div className="form-group mb-3">
											<label className="mb-1"><strong>Mật khẩu</strong></label>
											<input
												type="password"
									...
									<div className="new-account mt-3">
										<p>Bạn quên mật khẩu? <Link className="text-primary" to="./forgot-password">Quên mật khẩu</Link></p>
									</div>
								</div>
							</div>
						</div>
